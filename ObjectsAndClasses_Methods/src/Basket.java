public class Basket {
    ...
    private static double totalItemsCount = 0;
    ...
    public static void increaseTotalItemsPrice(int price, int count){
        Basket.totalItemsPrice = Basket.totalItemsPrice + (count * price);
    }
